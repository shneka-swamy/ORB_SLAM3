...
System::System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor,
               const bool bUseViewer, const int initFr, const string &strSequence, const std::string& saveAtlasFile):
    ...
    mbActivateLocalizationMode(false), mbDeactivateLocalizationMode(false), mbShutDown(false)
{
    ...
    mptLocalMapping = new thread(&ORB_SLAM3_O::LocalMapping::Run,mpLocalMapper);
    ...
    mptLoopClosing = new thread(&ORB_SLAM3_O::LoopClosing::Run, mpLoopCloser);
...
void System::SaveTrajectoryTUM(const string &filename)
{
    ...
    list<ORB_SLAM3_O::KeyFrame*>::iterator lRit = mpTracker->mlpReferences.begin();
